...
// http://www.cocoadev.com/index.pl?SavingNSSplitViewPosition

@interface NSSplitView (TeeBoyEnhancements)

- (void)restoreViewRects:(NSArray *)viewRectArray;
- (NSArray *)saveViewRects;
