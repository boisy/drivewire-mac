...
/*!
	...
	@discussion TBSerialManager manages the serial devices on a system.
	@updated 2007-06-25
 */
 ...
 */
+ (TBSerialManager *)defaultManager;
 ...
 */
- (TBSerialPort *)reservePort:(NSString *)name forOwner:(id)object error:(NSError **)error;
